        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              My primary interests are building new &nbsp;
              <i>
                <b className="purple">Web Technologies and Products </b>
              </i>
              and connecting business needs with technical solutions, effectively bridging the gap between users and developers.
              <br />
              <br />
              ...
              I have hands-on experience with database management systems like <b className="purple">MongoDB</b> and <b className="purple">MySQL</b>.
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/Thama-Mabatha"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/thama-mabatha-5b1942273"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
